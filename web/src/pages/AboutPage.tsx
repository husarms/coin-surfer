...
import { BoundedWaveLoader, Button, Card, IconContainer, LayoutSingleColumn } from "../components";
...
function AboutPage({ isLoading }: AboutPageProps): JSX.Element {
    return (
        <LayoutSingleColumn>
            ...
            <Card>
                <div className="body-2">
                    ...
                    {
                        !isLoading && <p className="p-b-m">The tab(s) above correspond with the product(s) that are currently being traded.</p>
                    }
                </div>
            </Card>
