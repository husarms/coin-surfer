...
import { Button, Card, LayoutSingleColumn } from "../components";
...
function AboutPage(): JSX.Element {
    return (
        <LayoutSingleColumn>
            ...
            <Button size='large' shadow={true} icon={true} className='m-b-2xl' onClick={() => window.open('https://github.com/husarms/coin-surfer#readme', '_blank')}>
